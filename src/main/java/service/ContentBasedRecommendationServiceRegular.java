...
@Service
public class ContentBasedRecommendationServiceRegular {

    private final MongoTemplate restaurantMongoTemplate;

    public ContentBasedRecommendationServiceRegular(@Qualifier("restaurantMongoTemplate") MongoTemplate restaurantMongoTemplate) {
